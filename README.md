...
## 📌 Описание проекта
Аналитический дашборд поведения пользователей мобильного приложения: DAU, retention и воронка конверсии пользователя на разных платформах (iOS, Android, Web)    
...
Доступ к дашборду:  
http://46.149.77.76:8501 \\пока недоступно в связи с миграцией моего дата центра
